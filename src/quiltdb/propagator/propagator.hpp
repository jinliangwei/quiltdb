...
public:
  Propagator();
  int Start(PropagatorConfig &_config);
...
private:
  ...
  boost::scoped_pointer<zmq::socket_t> prop_push_sock_;
  boost::scoped_pointer<zmq::socket_t> stop_pull_sock_;
  boost::scoped_pointer<zmq::socket_t> timer_pull_sock_;
